...
// Replace k9-showcase, K9 Showcase — See README.adoc for details., just run, K9 Showcase started successfully. with actuals
= k9-showcase — Quick Start for Users
:toc:
:toclevels: 2

== What is k9-showcase?

K9 Showcase — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/k9-showcase.git
cd k9-showcase
just setup
----
...
[source,bash]
----
just install --portable --prefix=./k9-showcase-portable
----
...
[source]
----
K9 Showcase started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/k9-showcase/wiki
