...
doctor:
    @echo "Running diagnostics for k9-showcase..."
...
help-me:
    @echo "=== k9-showcase Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/k9-showcase/issues/new"
    @echo ""
