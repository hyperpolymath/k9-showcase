...
// Replace k9-showcase, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= k9-showcase — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining k9-showcase for
...
* Upstream: https://github.com/hyperpolymath/k9-showcase/issues
